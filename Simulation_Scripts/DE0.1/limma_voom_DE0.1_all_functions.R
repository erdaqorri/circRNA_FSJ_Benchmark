################### limma-Voom functions for the six evaluated pipelines ###################
###### Author: Erda Alexandria Qorri ###### 
###### Date: 06-02-2026

set.seed(42)

##### 1. limma-voom default pipeline #####
library(dplyr)
library(edgeR)
library(limma)
library(tibble)
...
res <- run_limma_vdefault_with_truth(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep26_counts.csv",
  metadata_path    = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep26_design.csv",
  truth_set_path   = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep26_TP.csv",
  edgeR_norm       = "TMMwsp",
...
res <- run_limma_LmFit_with_truth(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep19_counts.csv",
  metadata_path    = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep19_design.csv",
  truth_set_path   = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep19_TP.csv",
  edgeR_norm       = "TMM",
  contrast_formula = "Breast.Cancer.Tissue-Normal.Adjacent.Tissue",
  thresholds       = c(0.01, 0.05, 0.10),
  threshold_col    = "adj.P.Val",   # recommend FDR for consistency
...
##### 4. limma-voom with normalization set to quantile #####
library(dplyr)
library(edgeR)
library(limma)
library(tibble)
...
res <- run_limma_vquantile_with_truth(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep1_counts.csv",
  metadata_path    = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep1_design.csv",
  truth_set_path   = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep1_TP.csv",
  # edgeR_norm       = NULL,
  contrast_formula = "Breast.Cancer.Tissue-Normal.Adjacent.Tissue",
  thresholds       = c(0.01, 0.05, 0.10),
  threshold_col    = "adj.P.Val",   # recommend FDR for consistency
