...
run_edgeR_with_truth <- function(bsj_counts_path,
                                 metadata_path,
  ...
  cat("Starting Step 5: Fitting the glmQLFit and testing the contrasts with glmQLFTest ...\n")  
...
res <- run_edgeR_with_truth(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep27_counts.csv",
  metadata_path    = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep27_design.csv",
  truth_set_path   = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0.1/BC_autofilter_counts_DE0.1_rep27_TP.csv",
  edgeR_norm       = "TMMwsp",
  contrast_formula = "Breast.Cancer.Tissue-Normal.Adjacent.Tissue",
  thresholds       = c(0.01, 0.05, 0.10),
  threshold_col    = "FDR",   # recommend FDR for consistency
  rep_id           = 30
)
