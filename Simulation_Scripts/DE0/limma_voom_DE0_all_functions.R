...
# run function
lima_default_results <- run_limma_default_DE0(
...
print(lima_default_results$metrics)
...
run_limma_voomlmFit_DE0 <- function(bsj_counts_path,
  ...
  tryCatch({
    ...
    de_results <- topTable(dgelist_v_efit, number = Inf)
...
# run function
voomlmFit_result <- run_limma_voomlmFit_DE0(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep4_counts.csv",
  metadata_path = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep4_design.csv",
  edgeR_norm  = "TMM",
  contrast_formula = "Breast.Cancer.Tissue-Normal.Adjacent.Tissue"
)

voomlmFit_result$metrics
...
# run function
lima_quantile_results <- run_limma_quantile_DE0(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep30_counts.csv",
  metadata_path = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep30_design.csv",
  # edgeR_norm  = "none",
  contrast_formula = "Breast.Cancer.Tissue-Normal.Adjacent.Tissue"
...
print(lima_quantile_results$metrics)