...
run_DESeq2_WaldTest_DE0 <- function(bsj_counts_path,
                           metadata_path,
...
# Run function
DESeq2_result <- run_DESeq2_WaldTest_DE0(
...
run_DESeq2_LTR_DE0 <- function(bsj_counts_path,
                           metadata_path,
                           pvalue_thresholds = c(0.01, 0.05, 0.10),
                           rep_id = NA) {
  # Start timer
...
# Run function
DESeq2_result <- run_DESeq2_LTR_DE0(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep11_counts.csv",
  metadata_path = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep11_design.csv"
)
...
run_DESeq2_beta_priorT_DE0 <- function(bsj_counts_path,
                           metadata_path,
                           pvalue_thresholds = c(0.01, 0.05, 0.10),
                           rep_id = NA) {
  # Start timer
...
# Run function
DESeq2_result <- run_DESeq2_beta_priorT_DE0(
  bsj_counts_path  = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep11_counts.csv",
  metadata_path = "/Users/alexakouri/Documents/DE_benchmarking_paper/simulations/BC/autofilter_counts/DE_0/BC_autofilter_counts_DE0_rep11_design.csv"
)
